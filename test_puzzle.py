...
from interpreter import collect_grid, patch


def test(
    puzzle, puzzle_spec, nelem={}, B={"B0": 32}, print_log=False, device="cpu"
) -> bool:
    ...
    if failures or print_log:
        ...
        for key, value in access_offsets.items():
            ...
            if is_invalid:
                print(
                    "Invalid access mask (True: valid access, False: invalid access): \n",
                    failures[key],
                )
